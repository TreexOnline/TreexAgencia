...
const services = [
  ...
  },
  {
    ...
    desc: "Robôs no WhatsApp e Instagram que respondem na hora, qualificam o cliente, agendam reuniões e mandam o lead pronto para você fechar. Funciona 24h, finais de semana, feriados.",
    points: ["Bot no WhatsApp e Direct", "Qualificação automática", "Integração com seu CRM"],
  },
  {
    icon: Code2,
    tag: "Desenvolvimento (DEV)",
    title: "Sites e sistemas feitos para vender — não para enfeitar.",
  ...
  },
  {
    ...
    desc: "Diagnóstico do seu negócio, análise dos concorrentes, definição de oferta, funil de vendas e calendário de execução. Você sai sabendo exatamente o que fazer para crescer.",
